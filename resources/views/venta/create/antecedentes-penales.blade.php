            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Nueva Venta / Presupuesto de Antecedentes Penales</span>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-12" >                                        
                                        <div class="form-group">                                            
                                            <label for="dato1">Clave fiscal:</label>
                                    ...
                                    <div class="col-12" >                                        
                                        <div class="form-group">                                            
                                            <label for="dato2">DNI frente: (Pegar URL)</label>
                                    ...
                                    <div class="col-12" >                                        
                                        <div class="form-group">                                            
                                            <label for="dato3">DNI dorso: (Pegar URL)</label>

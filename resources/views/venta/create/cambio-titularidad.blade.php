            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Nueva Venta / Presupuesto de Cambio de titularidad</span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="box box-info padding-1">
                            <div class="box-body">
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-12" >                                        
                                        <div class="form-group">                                            
                                            <label for="dato2">Certificado de domicilio: (Pegar URL)</label>
                                    ...
                                    <div class="col-12" >                                        
                                        <div class="form-group">                                            
                                            <label for="dato3">Foto de boleta del servicio (cualquiera: (Pegar URL)</label>

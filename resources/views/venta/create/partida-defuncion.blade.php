            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Nueva Venta / Presupuesto de Partida Defunción</span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="box box-info padding-1">
                            <div class="box-body">
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-6" >
                                        <div class="form-group">
                                            <label for="dato2">Fecha de Defunción</label>
                                            <input type="date" id="dato2" name="dato2" placeholder="" class="form-control">
                                        </div>
                                    </div>

                                    <div class="col-6" >
                                        <div class="form-group">Localidad de Defunción</label>

...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header card-presupuestos">
                                ...
                                <tbody>
                                    @foreach ($ventas as $venta)
                                        <tr>
                                            ...
                                            <td>
                                                <form class="alerta-mover" action="{{ route('estado.solicitud',$venta->id) }}" method="GET"><button class="btn btn-sm btn-solicitud"><i class="bi bi-arrow-left-circle-fill"></i> Solicitud</form>
                                                <form class="alerta-mover" action="{{ route('estado.enviado',$venta->id) }}" method="GET"><button class="btn btn-sm btn-enviado">Enviado <i class="bi bi-arrow-right-circle-fill"></i></form>                                                
                                            </td>

...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header card-enviados">
                        <div style="display: flex; justify-content: space-between; align-items: center;">

                            <span id="card_title">
                                <i class="bi bi-send-exclamation"></i> ENVIADOS A CLIENTE
                            </span>
                                ...
                                <tbody>
                                    @foreach ($ventas as $venta)
                                        <tr>
                                            ...
                                            <td>
                                                <form class="alerta-mover" action="{{ route('estado.presupuesto',$venta->id) }}" method="GET"><button class="btn btn-sm btn-presupuesto"><i class="bi bi-arrow-left-circle-fill"></i> Presupuesto</form>
                                                <form class="alerta-mover" action="{{ route('estado.confirmado',$venta->id) }}" method="GET"><button class="btn btn-sm btn-confirmado">Confirmado <i class="bi bi-arrow-right-circle-fill"></i></form>
                                            </td>

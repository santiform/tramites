...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header card-finalizados">
                        <div style="display: flex; justify-content: space-between; align-items: center;">

                            <span id="card_title">
                                <i class="bi bi-flag"></i> FINALIZADOS
                            </span>
                            ...
                            <table class="table search-table">
                                <thead class="thead">
                                    <tr>
                                        ...
                                        <th>Ganancia</th>
                                        <th><i class="bi bi-arrow-left-circle"></i> Mover a</th>
                                ...
                                <tbody>
                                    @foreach ($ventas as $venta)
                                        <tr>
                                            ...
                                            <td>
                                                <form class="alerta-mover" action="{{ route('estado.confirmado',$venta->id) }}" method="GET"><button class="btn btn-sm btn-confirmado"><i class="bi bi-arrow-left-circle-fill"></i> Confirmado</form>
                                            </td>

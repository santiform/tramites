...
<div class="container">
    ...
    <p><strong>Estado de pago:</strong> <img class="tick" src="https://localhost/tramites/resources/img/pendiente.png" height="30px" alt="QR"> <span class="naranja">PENDIENTE</span></p>
    <div class="barcode">

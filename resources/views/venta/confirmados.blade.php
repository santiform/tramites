                                ...
                                <tbody>
                                    @foreach ($ventas as $venta)
                                        <tr>
                                            ...
                                            <td>
                                                <form class="alerta-mover" action="{{ route('estado.enviado',$venta->id) }}" method="GET"><button class="btn btn-sm btn-enviado"><i class="bi bi-arrow-left-circle-fill"></i> Enviado</form>
                                                <form class="alerta-mover" action="{{ route('estado.finalizado',$venta->id) }}" method="GET"><button class="btn btn-sm btn-finalizado">Finalizado <i class="bi bi-arrow-right-circle-fill"></i></form>
                                            </td>
